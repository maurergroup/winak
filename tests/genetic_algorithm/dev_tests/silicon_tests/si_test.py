...
#### Performs a global optimization through a genetic algorithm on a given structure ####
...
#### input structure(s)
stru = read('/data/guest20/Executables/winak/tests/GA_stuff/Si111/Si111_3x3/less.traj') #path to an ase .traj file
...
MatingManager = "SemiRandomMating"
MutationManager = "ComplementaryMutation"
...
starting_population = Screener.generate(pop,popsize,minimum_diversity=0.035)
