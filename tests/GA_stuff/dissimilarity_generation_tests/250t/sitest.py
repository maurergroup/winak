...
MutationOperator = "GC"
FixedElements_GC = ["H"]
MutationOperatorParameters = {"prob":0.0,"stepwidth":2.50,"periodic":True,"constrain":False,"GA_mode":True,"adsorbate":999,"atm":"Si","adjust_cm":False}
...
starting_population = Screener.generate(pop,popsize,minimum_diversity=0.040)
