...
#
#   This file is part of INTERNALS
#
...
# COORDINATES #
###############
originally by Daniel Strobusch
...
from thctk.QD.InternalCoordinates import icSystem, normalizeIC
from thctk.numeric.Rotation import rigidBodySuperposition
from thctk.numeric.Quaternions import Quaternion
from thctk.QD.NormalModes import centerOfMass
from thctk.QC import AtomInfo
import thctk.QD._intcrd as intcrd
...
#REINI
class CompletePositionInternalEckartFrameCoordinates(InternalEckartFrameCoordinates):
    """
